...
def main():
    ...
    g['episode_id'] = (g.trade_date.diff().dt.days.fillna(99) > 4).cumsum()
    ...
    (ART/'h004_variant_summary.json').write_text(json.dumps(out,indent=2,default=str)); print(json.dumps(out,indent=2,default=str))
