...
def run():
 ...
 (ART/"h010_stabilization_volatility_contraction.json").write_text(json.dumps(out,indent=2,default=str),encoding='utf-8'); print(json.dumps(out,indent=2,default=str)); return out
