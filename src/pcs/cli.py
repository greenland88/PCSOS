...
def main():
    ...
    opportunity.add_argument("--families", default="HEALTHY_PULLBACK", help="HEALTHY_PULLBACK,SHALLOW_PULLBACK,BREAKOUT_RETEST,CONSTRUCTIVE_BASE; independent observation families")
    opportunity.add_argument("--summary", action="store_true", help="print a compact Chinese summary; still save complete typed artifacts")
