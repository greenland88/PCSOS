...
raw['signal_definition']={'creates_new_entry_dates':False,'purpose':'TRACK_A_EXECUTION_ONLY_WITH_FROZEN_EPISODES','track_a_execution_only':True,'execution_dates':execution_dates,'benchmark_symbol':'QQQ'}; spec=from_mapping(raw)
