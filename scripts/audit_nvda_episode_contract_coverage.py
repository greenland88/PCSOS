...
for _,e in ep.iterrows():
 for off in (-2,-1,0,1,2):
  day=pd.Timestamp(e.date)+pd.offsets.BDay(off); z=audit(day); z.update({'episode_id':e.episode_id,'offset_trading_days':off}); near.append(z)
