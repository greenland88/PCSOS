...
raw=yaml.safe_load((R/'research_configs/nvda_research_agent_round8_current_replay.yaml').read_text()); raw['research_id']='nvda_authoritative_delayed_replay_round21'; spec=from_mapping(raw)
