...
for s,(lo,hi) in W.items():
 r=run_backtest(stock(s,hi),stock('QQQ',hi),option_root=f'data/parquet/options_monthly/{s}',start=lo,end=hi,backend='duckdb',duckdb_path=':memory:',safe_strike_atr=a.atr)
