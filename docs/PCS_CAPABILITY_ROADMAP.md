...
| Stock observation and discussion packets | STEP 8 R1–R3 ACCEPTED; STEP 11A IN_PROGRESS | Step 8 accepted at `2d5fe9b86deed36c475fabae4315c5e52af2af7a`. Explicit STOCK_OBSERVATION scope now integrates canonical daily inputs, four families, typed run/resume/query and immutable component checkpoints in the existing pool runner. Production default unchanged; no options/provider/model calls. [Step 11A handoff](operations/selection_v2/step_11a.md) records validation scope and generation-replay limitation; 11B not adopted. |
